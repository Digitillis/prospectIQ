                ...
                <tbody className="divide-y divide-gray-50">
                  {paginated.map((contact) => (
                    <tr key={contact.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-gray-600 max-w-[180px] truncate" title={contact.title}>
                        {contact.title || "—"}
                      </td>
                      ...
                      <td className="px-4 py-3 text-gray-600">
                        {contact.department ? formatLabel(contact.department) : <span className="text-gray-400">—</span>}
                      </td>
