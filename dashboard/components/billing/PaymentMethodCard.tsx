 ...
 * Copy into any app: no external dependencies beyond Tailwind + lucide-react.
 */
  ...
  return (
    <div className="flex items-start justify-between gap-4">
      ...
      <button
        onClick={onUpdate}
        disabled={isUpdating}
        className="shrink-0 text-sm font-medium text-digitillis-accent hover:underline disabled:opacity-50"
      >
