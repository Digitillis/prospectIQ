 ...
 * Copy into any app: no external dependencies beyond Tailwind.
 */

import { usagePct, usageLevel, fmtNumber } from "@/lib/billing/utils";
...
export function UsageBar({ label, used, limit, icon, suffix, unlimited = false }: UsageBarProps) {
